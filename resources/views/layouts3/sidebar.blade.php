      ...
      <div class="main-navbar">
        ...
        <div id="mainnav">           
          <ul class="nav-menu custom-scrollbar">
            ...
            <li class="dropdown"><a class="nav-link menu-title" href=""><i data-feather="upload-cloud"></i><span>Penanggung Jawab</span></a></li>
            <li class="dropdown"><a class="nav-link menu-title" href=""><i data-feather="user"></i><span>Permintaan Akun</span></a></li>
