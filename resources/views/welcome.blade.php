    ...
    <body class="antialiased">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                <h4 class="text-light">Pick A Bin</h4>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        @auth
                            <li class="nav-item"><a class="nav-link" href="{{url('datauser')}}">Darsboard</a></li>
                        @else
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Mengelola Pengambilan Sampah dengan Efisien</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">Pick A Bin adalah sebuah platform digital yang dibangun dengan tujuan untuk kemudahan warga dan petugas kebersihan dalam mengelola jadwal pengambilan sampah.</p>
        ...
        <footer class="bg-light py-5">
            <div class="container px-4 px-lg-5"><div class="small text-center text-muted">Copyright &copy; 2022 - Pick A Bin</div></div>
        </footer>
