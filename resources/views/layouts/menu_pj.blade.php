                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                ...
                                <div class="user-content hide-menu m-l-10">
                                    <a href="#" class="" id="Userdd" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-decoration: none">
                                        <h5 class="m-b-0 user-name font-medium" id="nama-user"></h5>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-blue sidebar-link" href="{{ route('datauser') }}" aria-expanded="false" style="text-decoration: none ;">
