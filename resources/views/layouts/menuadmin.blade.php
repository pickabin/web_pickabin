                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('data_pj') }}" aria-expanded="false" style="text-decoration: none">
                                <i class="mdi mdi-plus"></i>
                                <span class="hide-menu">Tambah User</span>
                            </a>
                        </li>
                        {{-- <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('monitoruser') }}" aria-expanded="false" style="text-decoration: none">
